 ...
 */
final class Version20210228202555 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE evennement (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(20) NOT NULL, description VARCHAR(255) NOT NULL, date_deb DATE NOT NULL, date_fin DATE NOT NULL, prix INT NOT NULL, capacite INT NOT NULL, id_hotel INT NOT NULL, id_vol INT NOT NULL, id_transport INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
